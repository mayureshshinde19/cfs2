...
<div id="header-menu">
  ...
  <div class="sample-img">
    <div class="container">
      ...
      global $base_path;
      ?>
      <img src="<?php echo $base_path;?>sites/all/themes/corporateclean/images/sample.png" />
    </div>
  </div>
  <div id="header-menu-inside" class="container_12">    
    <div class="grid_12">
    ...
    <?php if ($page['sidebar_first'] && $page['sidebar_second']) { ?>
      ...
      elseif ($page['sidebar_first'] || $page['sidebar_second']) {
        ...
        <div id="main" class="grid_8">
          ...
          <?php
          if (theme_get_setting('breadcrumb_display', 'corporateclean')): print $breadcrumb;
          endif;
          ?>
    ...
    <div id="footer-bottom">
      ...
      <?php if (theme_get_setting('credits_display', 'corporateclean')): ?>
        ...
        <div id="credits" class="container_12 clearfix">
          <div class="grid_12">
            &COPY;<?php echo date('Y'); ?> Cloud Foundation Services
          </div>
        </div>
        <!-- EOF: #credits -->
      <?php endif; ?>
